...
public class ActivityContactusBindingImpl extends ActivityContactusBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_msg, 4);
        sViewsWithIds.put(R.id.ed_msg, 5);
        sViewsWithIds.put(R.id.ll_phone, 6);
        sViewsWithIds.put(R.id.ed_phone_no, 7);
        sViewsWithIds.put(R.id.llbotom, 8);
        sViewsWithIds.put(R.id.bt_send, 9);
    }
    // views
    @NonNull
