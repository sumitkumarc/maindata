...
public class ActivityProfileBindingImpl extends ActivityProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_save, 5);
        sViewsWithIds.put(R.id.ll_main, 6);
        sViewsWithIds.put(R.id.rl_profile, 7);
        sViewsWithIds.put(R.id.fl_update_profile, 8);
        sViewsWithIds.put(R.id.iv_user_profile, 9);
        sViewsWithIds.put(R.id.flProfile, 10);
        sViewsWithIds.put(R.id.ed_name, 11);
        sViewsWithIds.put(R.id.ed_phone_no, 12);
        sViewsWithIds.put(R.id.txt_sign_out, 13);
        sViewsWithIds.put(R.id.ll_order, 14);
        sViewsWithIds.put(R.id.txt_order, 15);
        sViewsWithIds.put(R.id.ll_cancelled, 16);
        sViewsWithIds.put(R.id.txt_cancelled, 17);
        sViewsWithIds.put(R.id.ll_total_spendes, 18);
        sViewsWithIds.put(R.id.txt_total_spend, 19);
    }
    // views
    @NonNull
