...
public final class CRowMyCartItemBinding implements ViewBinding {
  @NonNull
  ...
  private CRowMyCartItemBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout fist,
      @NonNull FrameLayout flQty, @NonNull ImageView ivAdd,
      @NonNull CircleImageView ivRestProfileImg, @NonNull ImageView ivSub,
      @NonNull LinearLayout llDeleteItem, @NonNull LinearLayout llEdit,
  ...
  @NonNull
  public static CRowMyCartItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CRowMyCartItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.c_row_my_cart_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CRowMyCartItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CRowMyCartItemBinding((LinearLayout) rootView, fist, flQty, ivAdd,
