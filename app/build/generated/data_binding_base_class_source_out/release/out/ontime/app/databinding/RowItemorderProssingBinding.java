...
public final class RowItemorderProssingBinding implements ViewBinding {
  @NonNull
  ...
  private RowItemorderProssingBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static RowItemorderProssingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowItemorderProssingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_itemorder_prossing, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowItemorderProssingBinding bind(@NonNull View rootView) {
