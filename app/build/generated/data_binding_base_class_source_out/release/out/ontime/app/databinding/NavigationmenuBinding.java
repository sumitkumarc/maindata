...
public final class NavigationmenuBinding implements ViewBinding {
  ...
  private NavigationmenuBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull ImageView AuthorAvatar, @NonNull TextView AuthorDisplayName,
      @NonNull TextView AuthorUserName, @NonNull ImageView close, @NonNull LinearLayout llabout,
      @NonNull LinearLayout llangages, @NonNull LinearLayout llcart,
  ...
  @NonNull
  public static NavigationmenuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NavigationmenuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.navigationmenu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NavigationmenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavigationmenuBinding((LinearLayoutCompat) rootView, AuthorAvatar,
          AuthorDisplayName, AuthorUserName, close, llabout, llangages, llcart, llcontact, llhome,
          llmyorder, llnotifi, llpaymet, llprofile, rly, svLeftHeader);
    }
