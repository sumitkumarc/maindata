...
public final class RRowCompletedItemBinding implements ViewBinding {
  @NonNull
  ...
  private RRowCompletedItemBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivRestImg,
  ...
  @NonNull
  public static RRowCompletedItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RRowCompletedItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.r_row_completed_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RRowCompletedItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RRowCompletedItemBinding((ConstraintLayout) rootView, ivRestImg, ivUserImg,
          txtDtype, txtOrderStatus, txtPtype, txtRestName, txtRestQty, txtUserName);
    }
